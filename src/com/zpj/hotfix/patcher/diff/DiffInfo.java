...
//
//import com.zpj.hotfix.patcher.utils.Formater;
...
//        throw new RuntimeException("can,t add new Field:" + field.getName() + "(" + field.getType() + "), " + "in class :" + field.getDefiningClass());
//    }
//
...
//        throw new RuntimeException("can,t modified Field:" + field.getName() + "(" + field.getType() + "), " + "in class :" + field.getDefiningClass());
//    }
//
...
//        System.out.println("add new Method:" + method.getReturnType() + "  " + method.getName() + "(" + Formater.formatStringList(method.getParameterTypes()) + ")  in Class:" + method.getDefiningClass());
...
//        System.out.println("add modified Method:" + method.getReturnType() + "  " + method.getName() + "(" + Formater.formatStringList(method.getParameterTypes()) + ")  in Class:" + method.getDefiningClass());
